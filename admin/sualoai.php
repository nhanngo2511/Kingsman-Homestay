...
CheckLogin();
$id = @$_GET['id'];
$lenh = "select * from categories where ID='$id'";
...
<head>
    ...
    <title>Admin | Sửa loại phòng</title>
...
<body>
	...
	<div class="col-lg-12">
        ...
        <li class="active"><i class="fa fa-pencil-square-o"></i> Sửa loại phòng</li>
		</ol>
	</div>
...
<div class="row">
  <div class="col-sm-9">
    <form class="form-horizontal" action="sualoaiphong.php" method="post">
      <?php
      while($row = mysqli_fetch_row($kq)){
              echo "<div class='form-group'>
                  <label class='control-label col-sm-2' for='email'>ID:</label>
                  <div class='col-sm-10'>
                    <input type='text' class='form-control' id='id' value='$row[0]' name='id' disabled>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='control-label col-sm-2' for='pwd'>Tên</label>
                  <div class='col-sm-10'>
                    <input type='text' class='form-control' id='nameP'  value='$row[1]' placeholder='Tên loại phòng' name='nameP'>
                  </div>
                </div>";
            }
       ?>
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          ...
          <button type="submit" class="btn btn-info">Sửa loại phòng</button>
        </div>
      </div>
    </form>
  </div>
