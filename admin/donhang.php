...
$lenh = "select * from orders order by ID DESC";
...
$p = $_GET["p"];
$x = ($p - 1)*$sodong;
$lenh1 = "select * from orders order by ID DESC limit ".$x.",".$sodong;
      ...
      while($row = mysqli_fetch_row($kq1))
        {
          ...
          echo "<tr>
            ...
            ";
            if ($row[11]==1) {
              echo "<td><a href='doitrangthai.php?id=$row[0]' onclick='Status()' data-toggle='tooltip' title='Đổi trạng thái'><button type='button' class='btn btn-warning'>Chưa nhận phòng</button></a></td>";
            }
            elseif ($row[11]==2) {
                echo "<td><a href='doitrangthai.php?id=$row[0]' onclick='Status()' data-toggle='tooltip' title='Đổi trạng thái'><button type='button' class='btn btn-success'>Đã nhận phòng</button></a></td>";
            }
            elseif ($row[11]==3) {
                echo "<td><button type='button' class='btn btn-info' data-toggle='tooltip' title='Đổi trạng thái'>Đã thanh toán</button></td>";
            }
            elseif ($row[11]==4) {
              echo "<td><button type='button' class='btn btn-danger' data-toggle='tooltip' title='Đổi trạng thái'>Đã huỷ</button></td>";
            }
            echo "<td>$ngaytao</td>
            <td>
            ...
            <a href='inputGhiChu.php?id=$row[0]'
              class='btn btn-warning btn-sm' data-toggle='tooltip' title='Thêm ghi chú'> <span
                class='fa fa-sticky-note'></span>
            </a>";
            if ($row[11]==1) {
              echo "  <a href='xoadonhang.php?id=$row[0]'
