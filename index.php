            ...
            <div class="card-body">
              <form method="GET" action="Search.php">
                  <div class="form-group">
                    ...
                    <input name="city" type="" class="form-control" id="" placeholder="Đà Lạt,Hồ Chí Minh,...">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="range" class="form-control" min="100000" max="1000000" name="price" id="price">
