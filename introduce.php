...
<body>
  ...
  <div class="container-fluid bg-3 text-center">    
    <div class="row">
      <div class="col-sm-4">
        <p>Nhân viên rất niềm nỡ và dễ chịu, đặc biệt luôn giúp đỡ hết khả năng.</p>
        <img src="admin/images/114938133.jpg" class="img-responsive margin" style="width:100%" alt="Image">
      </div>
      <div class="col-sm-4"> 
        <p>Chỗ nghỉ có bếp chung, đồ dùng dụng cụ đều hiện đại và mới mẻ</p>
 
        <img src="admin/images/78472249.jpg" class="img-responsive margin" style="width:100%" alt="Image">
      </div>
      <div class="col-sm-4"> 
        <p>Kingsman Homestay có trang bị Wi-Fi miễn phí và TV màn hình phẳng cho các phòng.</p>
        <img src="admin/images/80368180.jpg" class="img-responsive margin" style="width:100%" alt="Image">
      </div>
    </div>
  </div>
